...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('thumbnail', models.ImageField(upload_to='media/img/', verbose_name='Thumbnail')),
                ('song_title', models.CharField(max_length=255, verbose_name='Song Title')),
                ('song', models.FileField(help_text='Any audio format supported', upload_to='media/songs/', verbose_name='Song')),
